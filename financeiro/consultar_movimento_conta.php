...
$contas = $daoconta->ConsultarConta();
...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->FiltrarMovimentoConta($conta, $dt_inicial, $dt_final);
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Consultar Movimento por Conta</h2>
                        <h5>Consulte todos os movimentos por conta em um determinado período.</h5>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php foreach($contas as $item){?>
                                <option value="<?= $item['id_conta']?>"<?= $conta == $item['id_conta'] ? 'selected' : '' ?>><?= $item['banco_conta']?></option>
                            <?php } ?>
                            </select>
