...
$empresas = $daoempresa->ConsultarEmpresa();
...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->FiltrarMovimentoEmpresa($empresa, $dt_inicial, $dt_final);
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Consulte todos os movimentos por empresa em um determinado período.</h5>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
